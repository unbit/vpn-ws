...
* linux x86_64 static server (https://github.com/unbit/vpn-ws/releases/download/v0.1/vpn-ws-0.2-linux-x86_64.tar.gz)
* linux i386 static server (https://github.com/unbit/vpn-ws/releases/download/v0.1/vpn-ws-linux-i386.tar.gz)
* linux raspberrypi (raspbian) (https://github.com/unbit/vpn-ws/releases/download/v0.1/vpn-ws-0.2-linux-armv6l.tar.gz)
